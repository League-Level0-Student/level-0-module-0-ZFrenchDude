...
public class DragonFight {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if(question.equalsIgnoreCase("yell")) {
			...
			if(question.equalsIgnoreCase("kick")) {
	...
	static void playerLost() {
		...
		JOptionPane.showMessageDialog(null, "You have been defeated by the dragon! No treasure for you :(");
